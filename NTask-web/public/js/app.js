...
var _componentsSignin = require("./components/signin");

var _componentsSignin2 = _interopRequireDefault(_componentsSignin);

var _componentsSignup = require("./components/signup");

var _componentsSignup2 = _interopRequireDefault(_componentsSignup);

var _componentsTaskForm = require("./components/taskForm");

var _componentsTaskForm2 = _interopRequireDefault(_componentsTaskForm);
...
var App = (function () {
    function App(body, footer) {
        ...
        this.menu = new _componentsMenu2["default"](footer);
        this.signin = new _componentsSignin2["default"](body);
        this.signup = new _componentsSignup2["default"](body);
        this.taskForm = new _componentsTaskForm2["default"](body);
        this.tasks = new _componentsTasks2["default"](body);
        this.user = new _componentsUser2["default"](body);
    }
    ...
    _createClass(App, [{
        ...
        value: function signinEvents() {
            ...
            this.signin.on("signin", function (token) {
                ...
                _this2.menu.render("tasks");
                _this2.tasks.render();
            });
            this.signin.on("signup", function () {
                return _this2.signup.render();
            });
        }
    }, {
        key: "signupEvents",
...
var Menu = (function (_NTask) {
    ...
    _createClass(Menu, [{
        ...
        value: function render(path) {
            this.body.innerHTML = _templatesFooter2["default"].render(path);
            this.addEventListener();
        }
    }, {
        key: "clear",
...
var _templatesSignin = require("../templates/signin");

var _templatesSignin2 = _interopRequireDefault(_templatesSignin);
...
var Signin = (function (_NTask) {
    ...
    _createClass(Signin, [{
        ...
        value: function render() {
            this.body.innerHTML = _templatesSignin2["default"].render();
...
var _templatesTaskForm = require("../templates/taskForm");

var _templatesTaskForm2 = _interopRequireDefault(_templatesTaskForm);
...
var TaskForm = (function (_NTask) {
    ...
    _createClass(TaskForm, [{
        key: "render",
        value: function render() {
            this.body.innerHTML = _templatesTaskForm2["default"].render();
...
var _templatesTasks = require("../templates/tasks");

var _templatesTasks2 = _interopRequireDefault(_templatesTasks);
        ...
        value: function renderTaskList() {
            ...
            this.request(opts, function (err, resp, data) {
                if (err) {
                    ...
                    _this.body.innerHTML = _templatesTasks2["default"].render(data);
...
var _templatesUser = require("../templates/user");

var _templatesUser2 = _interopRequireDefault(_templatesUser);
        ...
        value: function renderUserData() {
            ...
            this.request(opts, function (err, resp, data) {
                if (err || resp.status === 412) {
                    ...
                    _this.body.innerHTML = _templatesUser2["default"].render(data);
                    _this.addEventListener();
                }
            });
        }
...
exports.render = function (path) {
    ...
    return "<div class=\"tabs-striped tabs-color-calm\">\n                <div class=\"tabs\">\n                    <a data-path=\"tasks\" class=\"tab-item " + isTasks + "\"><i class=\"icon ion-home\"></i></a>\n                    <a data-path=\"taskForm\" class=\"tab-item " + isTaskForm + "\"><i class=\"icon ion-compose\"></i></a>\n                    <a data-path=\"user\" class=\"tab-item " + isUser + "\"><i class=\"icon ion-person\"></i></a>\n                    <a data-logout class=\"tab-item\"><i class=\"icon ion-android-exit\"></i></a>\n                </div>\n            </div>";
};
...
exports.render = function () {
    return "<form>\n                <div class=\"list\">\n                    <label class=\"item item-input item-stacked-label\">\n                        <span class=\"input-label\">Email</span>\n                        <input type=\"text\" data-email>\n                    </label>\n                    <label class=\"item item-input item-stacked-label\">\n                        <span class=\"input-label\">Senha</span>\n                        <input type=\"password\" data-password>\n                    </label>\n                </div>\n                <div class=\"padding\">\n                    <button class=\"button button-positive button-block\"><i class=\"ion-home\"></i> Entrar</button>\n                </div>\n            </form>\n            <div class=\"padding\">\n                <button class=\"button button-block\" data-signup><i class=\"ion-person-add\"></i> Cadastrar</button>\n            </div>";
};
...
exports.render = function () {
    return "<form>\n                <div class=\"list\">\n                    <label class=\"item item-input item-stacked-label\">\n                        <span class=\"input-label\">Nome</span>\n                        <input type=\"text\" data-name>\n                    </label>\n                    <label class=\"item item-input item-stacked-label\">\n                        <span class=\"input-label\">Email</span>\n                        <input type=\"text\" data-email>\n                    </label>\n                    <label class=\"item item-input item-stacked-label\">\n                        <span class=\"input-label\">Senha</span>\n                        <input type=\"password\" data-password>\n                    </label>\n                </div>\n                <div class=\"padding\">\n                    <button class=\"button button-positive button-block\"><i class=\"ion-thumbsup\"></i> Cadastrar</button>\n                </div>\n            </form>";
};
...
exports.render = function () {
    return "<form>\n                <div class=\"list\">\n                    <label class=\"item item-input item-stacked-label\">\n                        <span class=\"input-label\">Tarefa</span>\n                        <input type=\"text\" data-task>\n                    </label>\n                </div>\n                <div class=\"padding\">\n                    <button class=\"button button-positive button-block\"><i class=\"ion-compose\"></i> Salvar</button>\n                </div>\n            </form>";
};
...
var renderTasks = function renderTasks(tasks) {
    return tasks.map(function (task) {
        ...
        return "<li>\n                    <i class=\"ion-" + done + "\" data-done data-task-done-\"" + (task.done ? 'done' : '') + "\" data-task-id-\"" + task.id + "\"></i>\n                    " + task.title + "\n                    <button data-remove data-task-id-\"" + task.id + "\" class=\"button button-assertive\"><i class=\"ion-trash-a\"></i></button>\n                </li>";
    }).join("");
};
...
exports.render = function (tasks) {
    ...
    return "<h4 class=\"text-content\">Nenhuma tarefa ainda</h4>";
};
